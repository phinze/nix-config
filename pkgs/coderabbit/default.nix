  ...
  selectSystem = system:
    {
      x86_64-linux = {
        os = "linux";
        arch = "x64";
        sha256 = "sha256-xiNSGPmwDvge38Q7OXOLQZBNa1CbryNvJA+0mCXNLks=";
      };
      aarch64-linux = {
        os = "linux";
        arch = "arm64";
        sha256 = "sha256-fZQzxZ54xJl5AkTu+PLzIgup3h/ze2EwvPiLJjbehZg=";
      };
      x86_64-darwin = {
        os = "darwin";
        arch = "x64";
        sha256 = "sha256-WVunR7wsxOlBog27dzMAARBpgcuVbspS1OTzajhCdyM=";
      };
      aarch64-darwin = {
        os = "darwin";
        arch = "arm64";
